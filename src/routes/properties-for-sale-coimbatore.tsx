...
const def = CATEGORIES.find((c) => c.path === "/properties-for-sale-coimbatore")!;

export const Route = createFileRoute("/properties-for-sale-coimbatore")({
  ...
  component: PropertiesForSaleCoimbatorePage,
});

function PropertiesForSaleCoimbatorePage() {
