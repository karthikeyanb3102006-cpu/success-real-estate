...
const def = CATEGORIES.find((c) => c.path === "/properties-for-rent-coimbatore")!;

export const Route = createFileRoute("/properties-for-rent-coimbatore")({
  ...
  component: PropertiesForRentCoimbatorePage,
});

function PropertiesForRentCoimbatorePage() {
