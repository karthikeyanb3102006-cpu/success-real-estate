...
const def = CATEGORIES.find((c) => c.path === "/houses-for-sale-coimbatore")!;

export const Route = createFileRoute("/houses-for-sale-coimbatore")({
  ...
  component: HousesForSaleCoimbatorePage,
});

function HousesForSaleCoimbatorePage() {
